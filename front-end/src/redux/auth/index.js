import {
    ...
    FORGOT_PASSWORD_RESET_PASSWORD, FORGOT_PASSWORD_RESET_PASSWORD_SUCCESSFUL, FORGOT_PASSWORD_SEND_OTP_SUCCESSFUL, FORGOT_PASSWORD_SEND_OTP, SAVE_TIME_OUT_OTP
} from "./action"
...
export const saveTimeOutOTP = (time) => {
    return {
        type: SAVE_TIME_OUT_OTP,
        time
    }
}
