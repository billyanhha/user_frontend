import {
    ...
    CHANGE_PHONE_VERIFY,
    CHANGE_PHONE_VERIFY_SUCCESSFUL,
    CHANGE_PHONE_SUCCESSFUL,
    CHANGE_PHONE,
    CHANGE_PHONE_CANCEL,
    CHANGE_PHONE_CANCEL_SUCCESSFUL,
    GET_PATIENT,
    GET_PATIENT_SUCCESSFUL,
    GET_USER_PACKAGE,
    GET_USER_PACKAGE_SUCCESSFUL,
    SUBCRIBE_EMAIL,
...
export const subcribeEmail = (data, type) => {
    return {
        type: SUBCRIBE_EMAIL,
        data,
        type
