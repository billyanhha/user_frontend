...
const MapWithADirectionsRenderer = compose(
    ...
    <GoogleMap
        defaultZoom={7}
        defaultCenter={new google.maps.LatLng(21.0277644, 105.8341598)}
    >
...
const MapWith = (props) => {
    ...
    useEffect(() => {
        setPatientPosition(props.patientAddress);
        setDoctorPosition({
            lat: props.doctorAddress.lat,
            lng: props.doctorAddress.lng
        })
    }, []);
    ...
    return (
        <div>
            {getDistance(patientPosition, doctorPosition)}
            <MapWithADirectionsRenderer patientPosition={patientPosition} doctorPosition={doctorPosition} />
        </div>
    );
