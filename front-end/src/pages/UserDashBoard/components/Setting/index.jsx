...
import { changePassword, getUserProfile, changeEmail, resetSettingStatus } from '../../../../redux/user';
import ChangePhone from './components/ChangePhone'
import { Modal, message, Switch } from 'antd';
import { LoadingOutlined, CloudOutlined, StarOutlined } from '@ant-design/icons';
            ...
            <div className="setting-content">
                <div className="setting-classify">
                    ...
                    <div className="setting-element">
                        ...
                        <div className="setting-element-value">{userProfile?.email ?? "Chưa liên kết"}</div>
                        <div className="setting-element-action" onClick={() => setVisiableEmail(true)}>Thay đổi</div>
                        <Modal centered title={userProfile?.email ? "Thay đổi email" : "Thêm email"} visible={visiableEmail} destroyOnClose={true} width={450} footer={null} onCancel={handleCancelModal}>
                            <div className="setting-email">
                                <form onSubmit={handleSubmit(handleChangeEmail)}>
                                    <div className="profile-form-field">
                                        ...
                                        <input type="email" className="profile-form-input" placeholder="___@___.___" name="email" defaultValue={userProfile?.email ?? ""}
                                            ref={register({
                                                pattern: {
                                                    value: /[\S+@\S+\.\S+]{6}/,
                                    ...
                                    <div className="setting-submit">
                                        <button disabled={isLoad} className={isLoad ? "upload-disable-button" : ""} type="submit">{isLoad ? <LoadingOutlined /> : ""} Cập nhật</button>
                                    </div>
                                </form>
                            </div>
                        </Modal>
                    ...
                    <div className="setting-element">
                        ...
                        <div className="setting-element-action" onClick={() => setVisiablePhoneModal(true)}>Thay đổi</div>
                        <Modal centered title="Đổi số điện thoại" visible={visiablePhoneModal} destroyOnClose={true} width={450} footer={null} onCancel={handleCancelModal}>
                            <ChangePhone />
                        </Modal>
                    </div>
                    <div className="setting-element">
                        ...
                        <div className="setting-element-action" onClick={() => setVisiablePassword(true)}>Thay đổi</div>
                        <Modal centered title="Đổi mật khẩu" visible={visiablePassword} destroyOnClose={true} width={450} footer={null} onCancel={handleCancelModal}>
                            <div className="setting-password">
                                <form onSubmit={handleSubmit(handleChangePassword)}>
                                    <div className="profile-form-field">
                                        <p className="profile-form-label">Mật khẩu hiện tại</p>
                                        <input type="password" className="profile-form-input" name="old_password" autoFocus
                                            ref={register({
                                                required: "Bạn hãy điền password ",
                                                minLength: {
                                                    value: 6,
                                        ...
                                        <input type="password" className="profile-form-input" name="password"
                                            ref={register({
                                                required: "Bạn hãy điền password ",
                                                minLength: {
                                                    value: 6,
                                                ...
                                                validate: value =>
                                                    value !== old_password.current || "Mật khẩu mới giống hiện tại "
                                            })}
                                        />
                                        ...
                                        <input
                                            ...
                                            ref={register({
                                                // required: "Bạn hãy điền password ",
                                                validate: value =>
                                                    value === password.current || "Mật khẩu mới không khớp "
                                            })}
                                        />
                ...
                <div className="setting-classify">
                    <div className="setting-content-header">Giao diện</div>
                    <div className="setting-element">
                        <div className="setting-element-name">Chủ đề</div>
                        <div className="setting-element-value">Sáng</div>
                        <div className="setting-element-action">
                            <Switch
